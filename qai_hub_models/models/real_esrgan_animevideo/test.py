...
from qai_hub_models.models.real_esrgan_animevideo.demo import IMAGE_ADDRESS
from qai_hub_models.models.real_esrgan_animevideo.demo import main as demo_main
...
OUTPUT_IMAGE_ADDRESS = CachedWebModelAsset.from_asset_store(
    MODEL_ID, MODEL_ASSET_VERSION, "real_esrgan_animevideo_demo_output.png"
)
...
def test_realesrgan_app():
    ...
    model = Real_ESRGAN_AnimeVideo.from_pretrained()
